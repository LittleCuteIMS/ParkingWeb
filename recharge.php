    ...
    <div class="bodywrapper">
        ...
        <div class="vernav">
            <ul>
                ...
                <li class="current"><a href="" class="editor">财务处理</a>
                    <span class="arrow"></span>
                    <ul id="formsub">
                        <li><a href="recharge.php">充值</a></li>
                    </ul>
                </li>
        ...
        <div class="centercontent">
            ...
            <div class="pageheader">            
                <ul class="hornav">
                	<li class="current"><a href="#charts">账户充值</a></li>
                </ul>
            </div><!--pageheader-->
                ...
                <div id="inbox" class="subcontent">
                    ...
                    <table cellpadding="0" cellspacing="0" border="1" class="stdtable mailinbox">                        
                        ...
                        <thead>
                            ...
                            <input type="submit" name="Submit" value="点击充值">
                            <p>
                            <?php 
