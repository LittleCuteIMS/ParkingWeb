...
<body class="loginpage">
	<div class="loginbox">
    	<div class="loginboxinner">
          ...
          <div class="logo">
            	<h1 class="logo"><span>停了吗</spran></h1>
...
if(isset($_POST['adminname'],$_POST['phone'],$_POST["email"],$_POST["pwd"])){
...
$comeout=mysqli_query($link, $sql1);
if(mysqli_num_rows($comeout)==1){
    echo "<script>
    ...
    $sql2="insert into administrator (admin_name,mobile,email,admin_pwd,date)
     values ('$admin_name','$mobile','$email','$admin_pwd','$regisDate')";
    mysqli_query($link, $sql2);
    $result=mysqli_query($link, "select * from administrator where mobile='$mobile' and email='$email'");    //检查数据是否录入成功，若成功反馈信息给客户端
